...
COMMAND: 'str' = 'execute as @s at @s run function item_border:new_collection with entity @s Inventory[{index}]\n'
INVENTORY_MAX: 'int' = 35
fileName: 'str' = 'inventory.mcfunction'
srcLoc: 'Path' = WORKSPACE / 'item border' / 'data' / 'item_border' / 'function'
